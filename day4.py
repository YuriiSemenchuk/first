...
def day4_2():
    ...
    range_names = len(names) - 1#оприділяю кількість змінних в масиві
    print(random.choice(names) + " is going to buy the meal today!") #вибиваю випадкове імя з масиву і пишу хто йде купляти
def day4_3():
    row1 = ["🛟", "🛟", "🛟"] #створюю масив першої лінії карти
    row2 = ["🛟", "🛟", "🛟"] #створюю масив другої лінії карти
    row3 = ["🛟", "🛟", "🛟"] #створюю масив третьої лінії карти
    map = [row1, row2,row3] #створюю масив з масивів ліній карти
    print(f"  {row1}\n  {row2}\n  {row3}") # вивожу карту
    ...
    map[vertical][horizontal] = "x" #міняю змінну на х масиві в масиві з масивів
    print(f"  {row1}\n  {row2}\n  {row3}") #вивожу змінену карту
def day4():
    user_choose = int(input("What do you choose? tipe 0 for Rok 1 fir Paper 2 for Scissors ")) #визначаю відповідь користувача
